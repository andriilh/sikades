$(document).ready(function () {
    ...
    const clearButton = `<button type="button" class="btn btn-default mr-2" onclick="location.href='${baseUrl}/CUtama/link_pengajuan_surat_sekertaris'">Semua</button>`;
    ...
    $.ajax({
        url: `${baseUrl}/pengajuan_surat/nama?type=mandiri`,
        beforeSend: function () {
