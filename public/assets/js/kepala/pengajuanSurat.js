$(document).ready(function () {
    ...
    const clearButton = `<button type="button" class="btn btn-default mr-2" onclick="location.href='${baseUrl}/CUtama/link_konfirmasi_pengajuan_surat'">Semua</button>`;
    ...
    $.ajax({
        url: `${baseUrl}/pengajuan_surat/nama?type=lurah pengajuan`,
        beforeSend: function () {
        ...
        success: function (response) {
            ...
            $(document).on("click", ".btn-filter", function () {
                ...
                location.href = `${baseUrl}/CUtama/link_konfirmasi_pengajuan_surat?filter=${name}`
            })
        }
    });
