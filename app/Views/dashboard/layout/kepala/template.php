...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <?= $this->include('dashboard/layout/kepala/navbar'); ?>
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        <?= $this->include('dashboard/layout/kepala/sidebar'); ?>
        <!-- /.Main sidebar -->

        <!-- Content Wrapper. Contains page content -->
        <?= $this->include('dashboard/layout/kepala/content'); ?>
        <!-- /.content-wrapper -->

        <!-- Footer -->
        <?= $this->include('dashboard/layout/kepala/footer'); ?>
        <!-- /.Footer -->
    </div>
    <!-- ./wrapper -->
