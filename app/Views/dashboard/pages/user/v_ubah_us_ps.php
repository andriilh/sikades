...
<div class="container col-11" style="margin-top: 30px;">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <form style="padding: 40px 20px 20px 20px;" method="post" action="<?= base_url(); ?>/CMasyarakat/ubah_us_ps_masyarakat">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="hidden" class="form-control" id="idmasyarakat" value="<?= $dataprofile['id_masyarakat']; ?>" readonly name="idmasyarakat" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="nama">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama" value="<?= $dataprofile['nama_masyarakat']; ?>" name="nama" readonly required>
                    </div>
                </div>
