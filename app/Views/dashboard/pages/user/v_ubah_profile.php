...
<div class="container col-11" style="margin-top: 30px;">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <form style="padding: 40px 20px 20px 20px;" method="post" action="<?= base_url(); ?>/CMasyarakat/ubah_profile_masyarakat">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="nama">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama" value="<?= $dataprofile['nama_masyarakat']; ?>" name="nama" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="idmasyarakat">Id Sekertaris</label>
                        <input type="text" class="form-control" id="idmasyarakat" value="<?= $dataprofile['id_masyarakat']; ?>" name="idmasyarakat" required readonly>
                    </div>
                    <div class="form-group col-md-3">
