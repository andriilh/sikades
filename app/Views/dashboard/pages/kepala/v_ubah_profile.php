...
<div class="container col-11" style="margin-top: 30px;">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <form style="padding: 40px 20px 20px 20px;" method="post" action="<?= base_url(); ?>/CLurah/ubah_profile_lurah">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="nama">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama" value="<?= $dataprofile['nama_lurah']; ?>" name="nama" required>
                    </div>
                    <div class="form-group col-md-3">
                        <label for="idlurah">Id Sekertaris</label>
                        <input type="text" class="form-control" id="idlurah" value="<?= $dataprofile['id_lurah']; ?>" name="idlurah" required readonly>
                    </div>
                    <div class="form-group col-md-3">
