                    ...
                    <tbody>
                        ...
                        <?php foreach ($datasuratmasuk as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url(); ?>/CUtama/link_lihat_file_surat_masuk_lurah/<?= $row['file']; ?>" class="btn btn-info btn-lihat" title="Detail"><i class=" fa-solid fa-eye"></i></a>
                                    ...
                                    if ($row['status'] == 'menunggu') { ?>
                                        <a href="#" type="button" class="btn btn-primary btn-edit" data-id="<?= $row['id_surat_masuk']; ?>" data-status="<?= $row['status']; ?>"><i class=" fa-solid fa-pen-clip" title="Ubah"></i></a>
                                    <?php } ?>
...
<!-- Form Ubah Surat -->
<form action="<?= base_url(); ?>/CLurah/ubah_status_surat_masuk" method="post">
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ubah Status Surat Masuk</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="id_surat_masuk_edit" class="col-form-label">Id Surat Masuk</label>
                        <input type="text" class="form-control id_surat_masuk_edit" id="id_surat_masuk_edit" readonly name="id_surat_masuk_edit" required>
                    </div>
...
<script>
    ...
    const clearButton = `<button type="button" class="btn btn-default mr-2" onclick="location.href='<?= base_url() ?>/CUtama/link_konfirmasi_surat_masuk'">Semua</button>`;
    const alphabet = [{
            name: "A",
            active: false,
            disabled: true
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>/pengajuan_surat/nama?type=lurah surat_masuk',
        beforeSend: function() {
        ...
        success: function(response) {
            ...
            $(document).on("click", ".btn-filter", function() {
                ...
                location.href = `<?= base_url() ?>/CUtama/link_konfirmasi_surat_masuk?filter=${name}`
            })
        }
    });
