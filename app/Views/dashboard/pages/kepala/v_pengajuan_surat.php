                    ...
                    <?php foreach ($datapengajuan as $row) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url(); ?>/CUtama/link_lihat_file_pengajuan_surat_lurah/<?= $row['file']; ?>" class="btn btn-info btn-lihat">
...
<!-- Form Ubah Surat -->
<form action="<?= base_url(); ?>/CLurah/ubah_pengajuan_surat_lurah" method="post">
...
<script>
    ...
    const clearButton = `<button type="button" class="btn btn-default mr-2" onclick="location.href='<?= base_url() ?>/CUtama/link_konfirmasi_pengajuan_surat'">Semua</button>`;
    const alphabet = [{
            name: "A",
            active: false,
            disabled: true
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>/pengajuan_surat/nama?type=lurah pengajuan',
        beforeSend: function() {
        ...
        success: function(response) {
            ...
            $(document).on("click", ".btn-filter", function() {
                ...
                location.href = `<?= base_url() ?>/CUtama/link_konfirmasi_pengajuan_surat?filter=${name}`
            })
        }
    });
