...
<div class="container col-11" style="margin-top: 30px;">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <form style="padding: 40px 20px 20px 20px;" method="post" action="<?= base_url(); ?>/CLurah/ubah_us_ps_lurah">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="hidden" class="form-control" id="idlurah" value="<?= $dataprofile['id_lurah']; ?>" readonly name="idlurah" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="nama">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama" value="<?= $dataprofile['nama_lurah']; ?>" name="nama" readonly required>
                    </div>
                </div>
